...
use utils::{convert_to_date, parse_logs, parse_params, LogContext, LogContextIterator};

const VOTE_ACCOUNT: &str = "Vote111111111111111111111111111111111111111";

#[substreams::handlers::map]
fn map_block(params: String, block: Block) -> Result<Output, substreams::errors::Error> {
    ...
    let programs_map = parse_params(&params);
...
fn process_inner_instruction(
    ...
    let data = inner_inst.data.clone();
